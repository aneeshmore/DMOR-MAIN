    ...
    const newPermissions = [
      {
        ...
        description: 'View SMART CRM Visit Reports List & Details',
      ...
      },
      {
        ...
        description: 'Create new SMART CRM Visit Reports',
        pagePath: '/operations/field-intelligence/new',
        pageLabel: 'New SMART CRM Visit Report',
        pageGroup: 'Sales',
        isPage: true,
      ...
      },
      {
        ...
        description: 'Edit existing SMART CRM Visit Reports',
        pagePath: '/operations/field-intelligence/:id/edit',
        pageLabel: 'Edit SMART CRM Visit Report',
        pageGroup: 'Sales',
        isPage: false,
      ...
      },
      {
        ...
        description: 'Delete SMART CRM Visit Reports',
        pagePath: '',
        pageLabel: 'Delete SMART CRM Visit Report',
        pageGroup: 'Sales',
        isPage: false,
      ...
      },
      {
        ...
        description: 'Export SMART CRM Visit Reports data',
        pagePath: '',
        pageLabel: 'Export SMART CRM Visit Data',
        pageGroup: 'Sales',
        isPage: false,
      ...
      },
      {
        ...
        description: 'View SMART CRM Dashboard & Analytics',
        pagePath: '/operations/field-intelligence/dashboard',
        pageLabel: 'SMART CRM Dashboard',
        pageGroup: 'Sales',
        isPage: true,
