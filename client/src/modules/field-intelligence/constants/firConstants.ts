...
export const FINISH_TYPES = ['Matt', 'Glossy', 'SemiGlossy'] as const;
...
export const RISK_FACTOR_OPTIONS = [
  ...
  'Product Trial Failure',
  'Logistics Challenges',
  'Market Uncertainty',
  'Seasonal Demand',
  'Customer Dissatisfaction',
  'Brand Loyalty to Competitor',
...
export const EXECUTIVE_RECOMMENDATION_OPTIONS = [
  ...
  'Product Demo Recommended',
  'Trial Order Recommended',
  'Commercial Negotiation Required',
  'Credit Evaluation Required',
  'Management Meeting Required',
  'Monitor and Follow Up',
  'Long-Term Opportunity',
  'Strategic Account Development',
  'Distributor Appointment Opportunity',
  'Dealer Expansion Opportunity',
  'Sample Submission Required',
  'Hold for Future Follow-up',
  'Low Potential',
  'Not Interested',
  'Competitor Locked',
  'Close Opportunity',
