...
import { useFieldArray, Control, UseFormRegister, FormState, useWatch, UseFormSetValue } from 'react-hook-form';
...
export const ActionItemsSection: React.FC<SectionProps> = ({ control, register, formState, setValue, watch }) => {
                  ...
                  return (
                    <>
                      <VoiceInput
                        ...
                        onChange={val => setValue(`followups.${index}.notes` as any, val, { shouldValidate: true })}
