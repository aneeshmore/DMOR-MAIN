...
export const addPdfFooter = (doc: jsPDF) => {
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    // 1. Draw page border frame (7mm margin top/left/right, leaving space above footer)
    doc.setLineWidth(0.3);
    doc.setDrawColor(0, 0, 0);
    doc.rect(7, 7, width - 14, height - 19);
    ...
    doc.text('Generated by Morex Technologies ERP', width / 2, height - 5, { align: 'center' });

    // Page number on bottom right
    doc.setFont('helvetica', 'normal');
    doc.text(`Page ${i} of ${pageCount}`, width - 14, height - 5, { align: 'right' });
  }
};
